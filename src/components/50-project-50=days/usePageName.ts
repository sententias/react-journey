...
export function usePageNames() {
  ...
  const pageNames = useMemo(() => [
    ...
    { name: 'FormInputWave', path: '/day8', component: FormInputWave },
    { name: 'SoundBoard', path: '/day9', component: SoundBoard },
    { name: 'DadJokes', path: '/day10', component: DadJokes },
    { name: 'EventKeycodes', path: '/day11', component: EventKeycodes },
    { name: 'FaqCollapse', path: '/day12', component: FaqCollapse },
